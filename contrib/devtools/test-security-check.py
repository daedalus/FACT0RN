...
class TestSecurityChecks(unittest.TestCase):
    ...
    def test_PE(self):
        ...
        self.assertEqual(
            ...
            (
                1,
                f'{executable}: failed PIE DYNAMIC_BASE HIGH_ENTROPY_VA NX RELOC_SECTION',
            ),
        )
        self.assertEqual(
            call_security_check(
            ...
            (
                1,
                f'{executable}: failed PIE DYNAMIC_BASE HIGH_ENTROPY_VA RELOC_SECTION',
            ),
        )
        self.assertEqual(
            call_security_check(
            ...
            (1, f'{executable}: failed PIE DYNAMIC_BASE HIGH_ENTROPY_VA'),
        )
        self.assertEqual(
            call_security_check(
                cc,
        ...
        self.assertEqual(
            ...
            (1, f'{executable}: failed HIGH_ENTROPY_VA'),
        )
    ...
    def test_MACHO(self):
        ...
        self.assertEqual(
            ...
            (
                1,
                f'{executable}: failed PIE NOUNDEFS NX LAZY_BINDINGS Canary CONTROL_FLOW',
            ),
        )
        self.assertEqual(
            call_security_check(
            ...
            (
                1,
                f'{executable}: failed PIE NOUNDEFS NX LAZY_BINDINGS CONTROL_FLOW',
            ),
        )
        self.assertEqual(
            call_security_check(
            ...
            (1, f'{executable}: failed PIE NOUNDEFS LAZY_BINDINGS CONTROL_FLOW'),
        )
        self.assertEqual(
            call_security_check(
                cc, source, executable, ['-Wl,-no_pie', '-fstack-protector-all']
            ),
            (1, f'{executable}: failed PIE LAZY_BINDINGS CONTROL_FLOW'),
        )
        self.assertEqual(
            call_security_check(
                cc,
